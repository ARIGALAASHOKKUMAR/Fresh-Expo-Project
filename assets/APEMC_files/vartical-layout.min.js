...
//created by chalamalasetty satish kumar to load onload styles
//call in sitelayout.jsx as event
function onloadThemeStyles() {
  $("#pcoded").pcodedmenu({
...
//created by chalamalasetty satish kumar to load onload styles
//call in sitelayout.jsx as event
window.addEventListener("onloadThemeStyles", onloadThemeStyles);
$(document).ready(), handlemenutype("st2");
